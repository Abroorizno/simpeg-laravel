                                        ...
                                        <table class="table mb-3" id="table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($datas as $major)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" class="btn btn-secondary"
                                                                ...
                                                                data-bs-target="#edit-major-{{ $major->id }}">EDIT</a>
                                                    ...
                                                    <!-- MODAL EDIT -->
                                                    <div class="modal fade" id="edit-major-{{ $major->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('majors.update', $major->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="row">
                                                                            <div class="col mb-3">
                                                                                <label
                                                                                    for="editClassyName{{ $major->id }}"
                                                                                    class="form-label">Major Name</label>
                                                                                <input type="text" name="name"
                                                                                    id="editClassName{{ $major->id }}"
                                                                                    class="form-control"
                                                                                    value="{{ $major->name }}" />
                                                                            </div>
                                                                        </div>
